...
export const UserRow = ({ user, onActionClick }) => {
    const defaultImg =
        ...
        <>
            ...
            <td className="actions">
                <button
                    ...
                    title="Edit"
                    onClick={() => onActionClick(user._id, ActionTypes.edit)}
                >
                    <svg
                        aria-hidden="true"
                        focusable="false"
                ...
                <button
                    ...
                    title="Delete"
                    onClick={() => onActionClick(user._id, ActionTypes.delete)}
                >
                    <svg
                        aria-hidden="true"
                        focusable="false"
                ...
                <button
                    ...
                    title="Info"
                    onClick={() => onActionClick(user._id, ActionTypes.details)}
                >
                    <svg
                        aria-hidden="true"
                        focusable="false"
